...
The script incorporates a specialized Git alias that, when you use a regular Git clone command with two arguments, changes to the cloned directory and bookmark the path automatically.